...
internal static class LauncherText
{
    ...
    public static string FallbackFor(string key) => key switch
    {
        ...
        "Launcher_Status_LaunchSucceededWithDiagnosticsFormat" => "{0} {1}",
        "Launcher_Status_LaunchFailedFormat" => "{0}",
        "Launcher_StartupDiagnostics_Format" => "{0}",
        "Launcher_Error_ShellLaunchFailedSafeFormat" => "{0}",
        "Launcher_Error_LocalOperationFailedSafeFormat" => "{0}",
