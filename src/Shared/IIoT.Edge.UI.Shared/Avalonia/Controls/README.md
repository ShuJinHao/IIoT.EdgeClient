...
当前公开 `Edge*` class：36 个，其中可实例化控件 35 个，`EdgeStatusControlBase` 是状态行为抽象基类。废弃控件：0 个。
...
- `Status`：`EdgeStatusControlBase`、`EdgeStatusDot`、`EdgeStatusChip`、`EdgeStatusListItem`、`EdgeVisualStatus`、`EdgeVisualVariant`
