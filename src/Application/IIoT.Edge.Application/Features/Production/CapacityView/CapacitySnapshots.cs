...
/// 年查询时，每行对应一个月份。
/// </summary>
public class DailyCapacitySnapshot
{
...
/// 半小时槽位查询快照，用于日查询明细。
/// </summary>
public class HourlyCapacitySlotSnapshot
{
...
/// <summary>
/// 日汇总查询快照，用于日查询回退场景以及月、年聚合的基础数据。
/// </summary>
public class DailyCapacitySummarySnapshot
{
    public int TotalCount { get; set; }
    public int OkCount { get; set; }
    public int NgCount { get; set; }
...
/// 图表柱状项查询快照。
/// </summary>
public class CapacityChartBarSnapshot
{
