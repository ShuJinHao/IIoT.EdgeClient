...
public partial class App : WpfApplication
{
    ...
    private ServiceCollection ConfigureServices(IConfiguration configuration)
    {
        ...
        var discoveredModules = PackageValidationModuleCatalog.DiscoverCompiledModules();
        var modules = PackageValidationModuleCatalog.CreateEnabledModules(configuration, discoveredModules);
