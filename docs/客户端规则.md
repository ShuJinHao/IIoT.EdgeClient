...
- EdgeClient CI/CD 不走 Docker、Harbor、GHCR、SCP 或 SSH。Windows hosted runner 只负责构建 runtime、installer artifact 和 Velopack releases；内网 Linux self-hosted runner 只负责把 GitHub Actions artifact 发布到 `/srv/iiot/edge-updates`。
