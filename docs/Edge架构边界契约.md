...
|---|---:|---|
| Host | 50 / 26 | `edge-test-inventory.json`、`discovered-test-inventory.json`、`required-test-counts.json` 与 26 份 TRX/coverage report 对齐；Host discovery 为 1068，failed=0、skipped=0 |
